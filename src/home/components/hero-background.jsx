      ...
      sx={[
        (theme) => ({
          ...
          background: `
            ...
            linear-gradient(180deg, ${theme.vars.palette.background.default} 0%, rgba(${theme.vars.palette.primary.mainChannel} / 0.15) 30%, rgba(${theme.vars.palette.primary.mainChannel} / 0.25) 50%, rgba(${theme.vars.palette.primary.mainChannel} / 0.15) 70%, ${theme.vars.palette.background.default} 100%)
          `,
          backdropFilter: 'blur(6px)',
          ...theme.applyStyles('dark', {
            background: `
              linear-gradient(180deg, rgba(20,26,33,0.2) 12%, rgba(20,26,33,0.1) 50%, rgba(20,26,33,0.2) 88%),
              linear-gradient(180deg, ${theme.vars.palette.background.default} 0%, rgba(${theme.vars.palette.primary.mainChannel} / 0.2) 30%, rgba(${theme.vars.palette.primary.mainChannel} / 0.3) 50%, rgba(${theme.vars.palette.primary.mainChannel} / 0.2) 70%, ${theme.vars.palette.background.default} 100%)
            `,
          }),
        }),
      ]}
