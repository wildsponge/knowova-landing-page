    ...
    <Box
      ...
      sx={[
        (theme) => ({
          ...
          position: 'absolute',
          background: `
            linear-gradient(180deg, rgba(255,255,255,0.92) 12%, rgba(255,255,255,0.8) 50%, rgba(255,255,255,0.92) 88%),
            linear-gradient(180deg, ${theme.vars.palette.background.default} 0%, rgba(${theme.vars.palette.primary.mainChannel} / 0.08) 30%, rgba(${theme.vars.palette.primary.mainChannel} / 0.12) 50%, rgba(${theme.vars.palette.primary.mainChannel} / 0.08) 70%, ${theme.vars.palette.background.default} 100%)
          `,
          backdropFilter: 'blur(6px)',
          ...theme.applyStyles('dark', {
            background: `
              linear-gradient(180deg, rgba(20,26,33,0.96) 12%, rgba(20,26,33,0.8) 50%, rgba(20,26,33,0.96) 88%),
              linear-gradient(180deg, ${theme.vars.palette.background.default} 0%, rgba(${theme.vars.palette.primary.mainChannel} / 0.08) 30%, rgba(${theme.vars.palette.primary.mainChannel} / 0.12) 50%, rgba(${theme.vars.palette.primary.mainChannel} / 0.08) 70%, ${theme.vars.palette.background.default} 100%)
            `,
          }),
        }),
