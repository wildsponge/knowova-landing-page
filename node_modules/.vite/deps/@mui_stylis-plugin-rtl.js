...
// node_modules/@mui/stylis-plugin-rtl/esm/index.js
...
function stylisRTLPlugin(element, index, children, callback) {
  if (element.type === KEYFRAMES || element.type === SUPPORTS || element.type === RULESET && (!element.parent || element.parent.type === MEDIA || element.parent.type === RULESET || element.parent.type === LAYER)) {
    const stringified = import_cssjanus.default.transform(stringifyPreserveComments(element, index, children));
...
var esm_default = stylisRTLPlugin;
export {
...
@mui/stylis-plugin-rtl/esm/index.js:
  (**
   ...
   *)
*/
//# sourceMappingURL=@mui_stylis-plugin-rtl.js.map
